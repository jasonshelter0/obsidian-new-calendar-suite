...
3. Paste the repo URL: `https://github.com/jasonshelter0/obsidian-new-calendar-suite`
4. BRAT will download the full plugin including holiday data

### Manual

Download `new-calendar-suite.zip` from the [latest release](https://github.com/jasonshelter0/obsidian-new-calendar-suite/releases) and extract into `.obsidian/plugins/new-calendar-suite/`.

### Community Plugins

Not yet listed. See [Releases](https://github.com/jasonshelter0/obsidian-new-calendar-suite/releases) for the latest version.
